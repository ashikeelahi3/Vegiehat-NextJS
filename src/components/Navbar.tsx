...
export default function Navbar() {
  ...
  // Define Clerk appearance based on current theme
  const clerkAppearance = {
    ...
    variables: theme === "dark" 
      ? {
          ...
          colorAlphaShade: "rgba(62, 136, 91, 0.1)",
      ...
      : {
          ...
          colorAlphaShade: "rgba(30, 86, 49, 0.1)",
          fontFamily: "var(--font-geist-sans), system-ui, sans-serif",
    ...
    elements: theme === "dark" 
      ? {
          ...
          identityPreviewEditButton: "text-vegiehat-accent"
        }
      : {
          formButtonPrimary: "bg-vegiehat-primary hover:bg-vegiehat-secondary text-white",
